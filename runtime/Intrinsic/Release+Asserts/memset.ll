...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !16), !dbg !26
  %cmp2 = icmp eq i64 %count, 0, !dbg !26
  br i1 %cmp2, label %while.end, label %while.body.lr.ph, !dbg !26

while.body.lr.ph:                                 ; preds = %entry
  %conv = trunc i32 %s to i8, !dbg !27
  br label %while.body, !dbg !26

while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %a.04 = phi i8* [ %dst, %while.body.lr.ph ], [ %incdec.ptr, %while.body ]
  %count.addr.03 = phi i64 [ %count, %while.body.lr.ph ], [ %dec, %while.body ]
  %dec = add i64 %count.addr.03, -1, !dbg !26
  %incdec.ptr = getelementptr inbounds i8* %a.04, i64 1, !dbg !27
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !17), !dbg !27
  store volatile i8 %conv, i8* %a.04, align 1, !dbg !27, !tbaa !28
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !16), !dbg !26
  %cmp = icmp eq i64 %dec, 0, !dbg !26
  br i1 %cmp, label %while.end, label %while.body, !dbg !26
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/Intrinsic//home/joker/klee-lf/runtime/Intrinsic/memset.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/Intrinsic/memset.c", metadata !"/home/joker/klee-lf/runtime/Intrinsic"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"memset.c", metadata !"/home/joker/klee-lf/runtime/Intrinsic"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/Intrinsic/memset.c]
...
!23 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
