...
while.cond:                                       ; preds = %while.cond, %entry
  %s.0 = phi i8* [ %str, %entry ], [ %incdec.ptr, %while.cond ]
  %0 = load i8* %s.0, align 1, !dbg !21, !tbaa !22
  %tobool = icmp eq i8 %0, 0, !dbg !21
  %incdec.ptr = getelementptr inbounds i8* %s.0, i64 1, !dbg !25
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !15), !dbg !25
  br i1 %tobool, label %while.end, label %while.cond, !dbg !21

while.end:                                        ; preds = %while.cond
  %sub.ptr.lhs.cast = ptrtoint i8* %s.0 to i64, !dbg !26
  %sub.ptr.rhs.cast = ptrtoint i8* %str to i64, !dbg !26
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !26
  ret i64 %sub.ptr.sub, !dbg !26
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/strlen.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/strlen.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"strlen.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/strlen.c]
