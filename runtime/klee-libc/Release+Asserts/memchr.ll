...
entry:
  ...
  %cmp = icmp eq i64 %n, 0, !dbg !31
  br i1 %cmp, label %return, label %do.body, !dbg !31

do.body:                                          ; preds = %entry, %do.cond
  %n.addr.0 = phi i64 [ %dec, %do.cond ], [ %n, %entry ]
  %p.0 = phi i8* [ %incdec.ptr, %do.cond ], [ %s, %entry ]
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !19), !dbg !32
  %0 = load i8* %p.0, align 1, !dbg !32, !tbaa !35
  %conv = zext i8 %0 to i32, !dbg !32
  %cmp1 = icmp eq i32 %conv, %c, !dbg !32
  br i1 %cmp1, label %return, label %do.cond, !dbg !32

do.cond:                                          ; preds = %do.body
  %incdec.ptr = getelementptr inbounds i8* %p.0, i64 1, !dbg !32
  %dec = add i64 %n.addr.0, -1, !dbg !38
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !18), !dbg !38
  %cmp4 = icmp eq i64 %dec, 0, !dbg !38
  br i1 %cmp4, label %return, label %do.body, !dbg !38

return:                                           ; preds = %do.cond, %do.body, %entry
  %retval.0 = phi i8* [ null, %entry ], [ null, %do.cond ], [ %p.0, %do.body ]
  ret i8* %retval.0, !dbg !39
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/memchr.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/memchr.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"memchr.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/memchr.c]
...
!20 = metadata !{i32 786443, metadata !5, metadata !21, i32 45, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/memchr.c]
!21 = metadata !{i32 786443, metadata !5, metadata !4, i32 45, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/memchr.c]
...
!33 = metadata !{i32 786443, metadata !5, metadata !34, i32 49, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/memchr.c]
!34 = metadata !{i32 786443, metadata !5, metadata !20, i32 48, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/memchr.c]
