...
entry:
  ...
  %0 = load i8* %from, align 1, !dbg !22, !tbaa !23
  store i8 %0, i8* %to, align 1, !dbg !22, !tbaa !23
  %tobool5 = icmp eq i8 %0, 0, !dbg !22
  br i1 %tobool5, label %while.end, label %while.body, !dbg !22

while.body:                                       ; preds = %entry, %while.body
  %to.addr.07 = phi i8* [ %incdec.ptr, %while.body ], [ %to, %entry ]
  %from.addr.06 = phi i8* [ %incdec.ptr1, %while.body ], [ %from, %entry ]
  %incdec.ptr = getelementptr inbounds i8* %to.addr.07, i64 1, !dbg !26
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !14), !dbg !26
  %incdec.ptr1 = getelementptr inbounds i8* %from.addr.06, i64 1, !dbg !26
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr1}, i64 0, metadata !15), !dbg !26
  %1 = load i8* %incdec.ptr1, align 1, !dbg !22, !tbaa !23
  store i8 %1, i8* %incdec.ptr, align 1, !dbg !22, !tbaa !23
  %tobool = icmp eq i8 %1, 0, !dbg !22
  br i1 %tobool, label %while.end, label %while.body, !dbg !22
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/strcpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/strcpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"strcpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/strcpy.c]
