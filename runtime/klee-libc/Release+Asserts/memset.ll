...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !16), !dbg !25
  %cmp2 = icmp eq i64 %count, 0, !dbg !25
  br i1 %cmp2, label %while.end, label %while.body.lr.ph, !dbg !25

while.body.lr.ph:                                 ; preds = %entry
  %conv = trunc i32 %s to i8, !dbg !26
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %0 = bitcast i8* %next.gep to <16 x i8>*, !dbg !26
  store <16 x i8> %broadcast.splat102, <16 x i8>* %0, align 1, !dbg !26
  %next.gep.sum150 = or i64 %index, 16, !dbg !26
  %1 = getelementptr i8* %dst, i64 %next.gep.sum150, !dbg !26
  %2 = bitcast i8* %1 to <16 x i8>*, !dbg !26
  store <16 x i8> %broadcast.splat102, <16 x i8>* %2, align 1, !dbg !26
  %index.next = add i64 %index, 32
  %3 = icmp eq i64 %index.next, %n.vec
  br i1 %3, label %middle.block, label %vector.body, !llvm.loop !27
...
while.body:                                       ; preds = %middle.block, %while.body
  ...
  %dec = add i64 %count.addr.03, -1, !dbg !25
  %incdec.ptr = getelementptr inbounds i8* %a.04, i64 1, !dbg !26
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !17), !dbg !26
  store i8 %conv, i8* %a.04, align 1, !dbg !26, !tbaa !30
  tail call void @llvm.dbg.value(metadata !{i64 %dec}, i64 0, metadata !16), !dbg !25
  %cmp = icmp eq i64 %dec, 0, !dbg !25
  br i1 %cmp, label %while.end, label %while.body, !dbg !25, !llvm.loop !33
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/memset.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/memset.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"memset.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/memset.c]
...
!22 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
