...
entry:
  ...
  %0 = load i32* @NumAtExit, align 4, !dbg !38, !tbaa !40
  %cmp6 = icmp eq i32 %0, 0, !dbg !38
  br i1 %cmp6, label %for.end, label %for.body, !dbg !38

for.body:                                         ; preds = %entry, %for.body
  %i.07 = phi i32 [ %inc, %for.body ], [ 0, %entry ]
  %idxprom = zext i32 %i.07 to i64, !dbg !44
  %fn = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %idxprom, i32 0, !dbg !44
  %1 = load void (i8*)** %fn, align 8, !dbg !44, !tbaa !45
  %arg = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %idxprom, i32 1, !dbg !44
  %2 = load i8** %arg, align 8, !dbg !44, !tbaa !48
  tail call void %1(i8* %2) #4, !dbg !44
  %inc = add i32 %i.07, 1, !dbg !38
  tail call void @llvm.dbg.value(metadata !{i32 %inc}, i64 0, metadata !10), !dbg !38
  %3 = load i32* @NumAtExit, align 4, !dbg !38, !tbaa !40
  %cmp = icmp ult i32 %inc, %3, !dbg !38
...
entry:
  ...
  %0 = load i32* @NumAtExit, align 4, !dbg !54, !tbaa !40
  %cmp = icmp eq i32 %0, 128, !dbg !54
...
if.end:                                           ; preds = %entry
  %idxprom = zext i32 %0 to i64, !dbg !57
  %fn1 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %idxprom, i32 0, !dbg !57
  store void (i8*)* %fn, void (i8*)** %fn1, align 8, !dbg !57, !tbaa !45
  %arg4 = getelementptr inbounds [128 x %struct.anon]* @AtExit, i64 0, i64 %idxprom, i32 1, !dbg !58
  store i8* %arg, i8** %arg4, align 8, !dbg !58, !tbaa !48
  %inc = add i32 %0, 1, !dbg !59
  store i32 %inc, i32* @NumAtExit, align 4, !dbg !59, !tbaa !40
  ret i32 0, !dbg !60
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !24, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/__cxa_atexit.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/__cxa_atexit.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"__cxa_atexit.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/__cxa_atexit.c]
...
!39 = metadata !{i32 786443, metadata !5, metadata !4, i32 25, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/__cxa_atexit.c]
...
!55 = metadata !{i32 786443, metadata !5, metadata !12, i32 37, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/__cxa_atexit.c]
