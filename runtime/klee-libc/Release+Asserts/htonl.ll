...
entry:
  ...
  %or = tail call i16 @llvm.bswap.i16(i16 %v), !dbg !30
  ret i16 %or, !dbg !30
}
...
entry:
  ...
  %shr = lshr i32 %v, 16, !dbg !32
  %conv = trunc i32 %shr to i16, !dbg !32
  tail call void @llvm.dbg.value(metadata !{i16 %conv}, i64 0, metadata !33) #2, !dbg !34
  %or.i = tail call i16 @llvm.bswap.i16(i16 %conv) #2, !dbg !35
  %conv1 = zext i16 %or.i to i32, !dbg !32
  %conv2 = trunc i32 %v to i16, !dbg !32
  tail call void @llvm.dbg.value(metadata !{i16 %conv2}, i64 0, metadata !33) #2, !dbg !34
  %or.i6 = tail call i16 @llvm.bswap.i16(i16 %conv2) #2, !dbg !35
  %conv4 = zext i16 %or.i6 to i32, !dbg !32
  %shl = shl nuw i32 %conv4, 16, !dbg !32
  %or = or i32 %shl, %conv1, !dbg !32
  ret i32 %or, !dbg !32
}
...
entry:
  ...
  %or.i = tail call i16 @llvm.bswap.i16(i16 %v) #2, !dbg !40
  ret i16 %or.i, !dbg !38
}
...
entry:
  ...
  %shr.i = lshr i32 %v, 16, !dbg !45
  %conv.i = trunc i32 %shr.i to i16, !dbg !45
  tail call void @llvm.dbg.value(metadata !{i16 %conv.i}, i64 0, metadata !46) #2, !dbg !47
  %or.i.i = tail call i16 @llvm.bswap.i16(i16 %conv.i) #2, !dbg !48
  %conv1.i = zext i16 %or.i.i to i32, !dbg !45
  %conv2.i = trunc i32 %v to i16, !dbg !45
  tail call void @llvm.dbg.value(metadata !{i16 %conv2.i}, i64 0, metadata !46) #2, !dbg !47
  %or.i6.i = tail call i16 @llvm.bswap.i16(i16 %conv2.i) #2, !dbg !48
  %conv4.i = zext i16 %or.i6.i to i32, !dbg !45
  %shl.i = shl nuw i32 %conv4.i, 16, !dbg !45
  %or.i = or i32 %shl.i, %conv1.i, !dbg !45
  ret i32 %or.i, !dbg !43
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/htonl.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/htonl.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"htonl.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/htonl.c]
