...
entry:
  ...
  %conv2 = ashr exact i32 %sext, 24, !dbg !25
  br label %for.cond, !dbg !29

for.cond:                                         ; preds = %for.cond, %entry
  %t.addr.0 = phi i8* [ %t, %entry ], [ %incdec.ptr, %for.cond ]
  %l.0 = phi i8* [ null, %entry ], [ %t.addr.0.l.0, %for.cond ]
  %0 = load i8* %t.addr.0, align 1, !dbg !25, !tbaa !30
  %conv1 = sext i8 %0 to i32, !dbg !25
  %cmp = icmp eq i32 %conv1, %conv2, !dbg !25
  tail call void @llvm.dbg.value(metadata !{i8* %t.addr.0}, i64 0, metadata !18), !dbg !25
  %t.addr.0.l.0 = select i1 %cmp, i8* %t.addr.0, i8* %l.0, !dbg !25
  %tobool = icmp eq i8 %0, 0, !dbg !33
  %incdec.ptr = getelementptr inbounds i8* %t.addr.0, i64 1, !dbg !35
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !15), !dbg !35
  br i1 %tobool, label %if.then4, label %for.cond, !dbg !33

if.then4:                                         ; preds = %for.cond
  ret i8* %t.addr.0.l.0, !dbg !33
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/strrchr.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/strrchr.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"strrchr.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/strrchr.c]
...
!26 = metadata !{i32 786443, metadata !5, metadata !27, i32 18, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strrchr.c]
!27 = metadata !{i32 786443, metadata !5, metadata !28, i32 17, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strrchr.c]
!28 = metadata !{i32 786443, metadata !5, metadata !4, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strrchr.c]
...
!34 = metadata !{i32 786443, metadata !5, metadata !27, i32 18, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strrchr.c]
