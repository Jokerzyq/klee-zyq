...
entry:
  ...
  %0 = load i8* %from, align 1, !dbg !20, !tbaa !22
  store i8 %0, i8* %to, align 1, !dbg !20, !tbaa !22
  %tobool5 = icmp eq i8 %0, 0, !dbg !20
  br i1 %tobool5, label %for.end, label %for.inc, !dbg !20
...
for.inc:                                          ; preds = %entry, %for.inc
  ...
  %incdec.ptr = getelementptr inbounds i8* %from.addr.07, i64 1, !dbg !20
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !15), !dbg !20
  %incdec.ptr1 = getelementptr inbounds i8* %to.addr.06, i64 1, !dbg !20
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr1}, i64 0, metadata !14), !dbg !20
  %1 = load i8* %incdec.ptr, align 1, !dbg !20, !tbaa !22
  store i8 %1, i8* %incdec.ptr1, align 1, !dbg !20, !tbaa !22
  %tobool = icmp eq i8 %1, 0, !dbg !20
  br i1 %tobool, label %for.end, label %for.inc, !dbg !20

for.end:                                          ; preds = %for.inc, %entry
  %to.addr.0.lcssa = phi i8* [ %to, %entry ], [ %incdec.ptr1, %for.inc ]
  ret i8* %to.addr.0.lcssa, !dbg !25
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/stpcpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/stpcpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"stpcpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/stpcpy.c]
...
!21 = metadata !{i32 786443, metadata !5, metadata !4, i32 41, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/stpcpy.c]
