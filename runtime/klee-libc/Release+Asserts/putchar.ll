...
entry:
  ...
  %conv = trunc i32 %c to i8, !dbg !18
  tail call void @llvm.dbg.value(metadata !{i8 %conv}, i64 0, metadata !12), !dbg !18
  store i8 %conv, i8* %x, align 1, !dbg !18, !tbaa !19
  %call = call i64 @write(i32 1, i8* %x, i64 1) #3, !dbg !22
  %cmp = icmp eq i64 %call, 1, !dbg !22
  %c. = select i1 %cmp, i32 %c, i32 -1, !dbg !24
  ret i32 %c., !dbg !25
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/putchar.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/putchar.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"putchar.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/putchar.c]
...
!16 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
...
!23 = metadata !{i32 786443, metadata !5, metadata !4, i32 18, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/putchar.c]
