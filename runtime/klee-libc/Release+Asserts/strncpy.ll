...
entry:
  ...
  %cmp = icmp eq i64 %n, 0, !dbg !27
  br i1 %cmp, label %if.end11, label %do.body, !dbg !27
...
do.body:                                          ; preds = %entry, %do.cond
  ...
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr}, i64 0, metadata !22), !dbg !28
  %0 = load i8* %s.0, align 1, !dbg !28, !tbaa !31
  tail call void @llvm.dbg.value(metadata !{i8* %incdec.ptr1}, i64 0, metadata !19), !dbg !28
  store i8 %0, i8* %d.0, align 1, !dbg !28, !tbaa !31
  %cmp2 = icmp eq i8 %0, 0, !dbg !28
  br i1 %cmp2, label %while.cond.preheader, label %do.cond, !dbg !28

while.cond.preheader:                             ; preds = %do.body
  %cmp517 = icmp eq i64 %n.addr.0, 1, !dbg !34
  br i1 %cmp517, label %if.end11, label %while.body.lr.ph, !dbg !34

while.body.lr.ph:                                 ; preds = %while.cond.preheader
  %1 = add i64 %indvar, 1, !dbg !34
  %scevgep = getelementptr i8* %dst, i64 %1
  %2 = add i64 %n, -1, !dbg !34
  %3 = sub i64 %2, %indvar, !dbg !34
  call void @llvm.memset.p0i8.i64(i8* %scevgep, i8 0, i64 %3, i32 1, i1 false), !dbg !36
  br label %if.end11, !dbg !34

do.cond:                                          ; preds = %do.body
  %incdec.ptr1 = getelementptr inbounds i8* %d.0, i64 1, !dbg !28
  %incdec.ptr = getelementptr inbounds i8* %s.0, i64 1, !dbg !28
  %dec8 = add i64 %n.addr.0, -1, !dbg !37
  tail call void @llvm.dbg.value(metadata !{i64 %dec8}, i64 0, metadata !18), !dbg !37
  %cmp9 = icmp eq i64 %dec8, 0, !dbg !37
  %indvar.next = add i64 %indvar, 1, !dbg !37
  br i1 %cmp9, label %if.end11, label %do.body, !dbg !37
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/klee-libc//home/joker/klee-lf/runtime/klee-libc/strncpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/klee-libc/strncpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"strncpy.c", metadata !"/home/joker/klee-lf/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
...
!20 = metadata !{i32 786443, metadata !5, metadata !21, i32 44, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
!21 = metadata !{i32 786443, metadata !5, metadata !4, i32 44, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
...
!29 = metadata !{i32 786443, metadata !5, metadata !30, i32 49, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
!30 = metadata !{i32 786443, metadata !5, metadata !20, i32 48, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
...
!35 = metadata !{i32 786443, metadata !5, metadata !29, i32 49, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/klee-libc/strncpy.c]
