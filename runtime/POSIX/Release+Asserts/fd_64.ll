...
entry:
  ...
  %and = and i32 %flags, 64, !dbg !200
  %tobool = icmp eq i32 %and, 0, !dbg !200
...
if.then:                                          ; preds = %entry
  ...
  %arraydecay1 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*, !dbg !202
  call void @llvm.va_start(i8* %arraydecay1), !dbg !202
  %gp_offset_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0, !dbg !203
  %gp_offset = load i32* %gp_offset_p, align 16, !dbg !203
  %fits_in_gp = icmp ult i32 %gp_offset, 41, !dbg !203
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !203

vaarg.in_reg:                                     ; preds = %if.then
  %0 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3, !dbg !203
  %reg_save_area = load i8** %0, align 16, !dbg !203
  %1 = sext i32 %gp_offset to i64, !dbg !203
  %2 = getelementptr i8* %reg_save_area, i64 %1, !dbg !203
  %3 = add i32 %gp_offset, 8, !dbg !203
  store i32 %3, i32* %gp_offset_p, align 16, !dbg !203
  br label %vaarg.end, !dbg !203

vaarg.in_mem:                                     ; preds = %if.then
  %overflow_arg_area_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2, !dbg !203
  %overflow_arg_area = load i8** %overflow_arg_area_p, align 8, !dbg !203
  %overflow_arg_area.next = getelementptr i8* %overflow_arg_area, i64 8, !dbg !203
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !203
  br label %vaarg.end, !dbg !203

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %2, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32*, !dbg !203
  %4 = load i32* %vaarg.addr, align 4, !dbg !203
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !16), !dbg !203
  call void @llvm.va_end(i8* %arraydecay1), !dbg !204
  br label %if.end, !dbg !205

if.end:                                           ; preds = %entry, %vaarg.end
  %mode.0 = phi i32 [ %4, %vaarg.end ], [ 0, %entry ]
  %call = call i32 @__fd_open(i8* %pathname, i32 %flags, i32 %mode.0) #2, !dbg !206
...
entry:
  ...
  %and = and i32 %flags, 64, !dbg !209
  %tobool = icmp eq i32 %and, 0, !dbg !209
  br i1 %tobool, label %if.end, label %if.then, !dbg !209

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata !{[1 x %struct.__va_list_tag]* %ap}, metadata !45), !dbg !210
  %arraydecay1 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*, !dbg !211
  call void @llvm.va_start(i8* %arraydecay1), !dbg !211
  %gp_offset_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0, !dbg !212
  %gp_offset = load i32* %gp_offset_p, align 16, !dbg !212
  %fits_in_gp = icmp ult i32 %gp_offset, 41, !dbg !212
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !212

vaarg.in_reg:                                     ; preds = %if.then
  %0 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3, !dbg !212
  %reg_save_area = load i8** %0, align 16, !dbg !212
  %1 = sext i32 %gp_offset to i64, !dbg !212
  %2 = getelementptr i8* %reg_save_area, i64 %1, !dbg !212
  %3 = add i32 %gp_offset, 8, !dbg !212
  store i32 %3, i32* %gp_offset_p, align 16, !dbg !212
  br label %vaarg.end, !dbg !212

vaarg.in_mem:                                     ; preds = %if.then
  %overflow_arg_area_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2, !dbg !212
  %overflow_arg_area = load i8** %overflow_arg_area_p, align 8, !dbg !212
  %overflow_arg_area.next = getelementptr i8* %overflow_arg_area, i64 8, !dbg !212
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !212
  br label %vaarg.end, !dbg !212

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %2, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32*, !dbg !212
  %4 = load i32* %vaarg.addr, align 4, !dbg !212
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !44), !dbg !212
  call void @llvm.va_end(i8* %arraydecay1), !dbg !213
  br label %if.end, !dbg !214

if.end:                                           ; preds = %entry, %vaarg.end
  %mode.0 = phi i32 [ %4, %vaarg.end ], [ 0, %entry ]
  %call = call i32 @__fd_openat(i32 %fd, i8* %pathname, i32 %flags, i32 %mode.0) #2, !dbg !215
...
entry:
  ...
  %call = tail call i64 @__fd_lseek(i32 %fd, i64 %offset, i32 %whence) #2, !dbg !217
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !219
  %call = tail call i32 @__fd_stat(i8* %path, %struct.stat64* %0) #2, !dbg !219
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !221
  %call = tail call i32 @__fd_stat(i8* %path, %struct.stat64* %0) #2, !dbg !221
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !223
  %call = tail call i32 @__fd_lstat(i8* %path, %struct.stat64* %0) #2, !dbg !223
  ret i32 %call, !dbg !223
}
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !225
  %call = tail call i32 @__fd_lstat(i8* %path, %struct.stat64* %0) #2, !dbg !225
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !227
  %call = tail call i32 @__fd_fstat(i32 %fd, %struct.stat64* %0) #2, !dbg !227
...
entry:
  ...
  %0 = bitcast %struct.stat* %buf to %struct.stat64*, !dbg !229
  %call = tail call i32 @__fd_fstat(i32 %fd, %struct.stat64* %0) #2, !dbg !229
...
entry:
  ...
  %call = tail call i32 @__fd_ftruncate(i32 %fd, i64 %length) #2, !dbg !231
...
entry:
  ...
  %call = tail call i32 @__fd_statfs(i8* %path, %struct.statfs* %buf) #2, !dbg !233
...
entry:
  ...
  %0 = bitcast %struct.dirent* %dirp to %struct.dirent64*, !dbg !235
  %call = tail call i32 @__fd_getdents(i32 %fd, %struct.dirent64* %0, i32 %count) #2, !dbg !235
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/POSIX//home/joker/klee-lf/runtime/POSIX/fd_64.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/POSIX/fd_64.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"fd_64.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/POSIX/fd_64.c]
...
!21 = metadata !{i32 786443, metadata !5, metadata !22, i32 48, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_64.c]
!22 = metadata !{i32 786443, metadata !5, metadata !4, i32 48, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_64.c]
...
!46 = metadata !{i32 786443, metadata !5, metadata !47, i32 62, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_64.c]
!47 = metadata !{i32 786443, metadata !5, metadata !37, i32 62, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_64.c]
...
!87 = metadata !{metadata !"/usr/include/time.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!142 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/statfs.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!157 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/types.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!178 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/dirent.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!197 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
