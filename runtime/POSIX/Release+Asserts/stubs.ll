...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !742
  store i32 97, i32* %call, align 4, !dbg !742, !tbaa !743
  ret i32 -1, !dbg !747
}
...
entry:
  ...
  %call = tail call i32 @__fgetc_unlocked(%struct._IO_FILE* %f) #9, !dbg !749
...
entry:
  ...
  %call = tail call i32 @__fputc_unlocked(i32 %c, %struct._IO_FILE* %f) #9, !dbg !751
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !754
  store i32 5, i32* %call, align 4, !dbg !754, !tbaa !743
  ret i32 -1, !dbg !755
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !758
  store i32 5, i32* %call, align 4, !dbg !758, !tbaa !743
  ret i32 -1, !dbg !759
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !762
  store i32 5, i32* %call, align 4, !dbg !762, !tbaa !743
  ret i32 -1, !dbg !763
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !766
  store i32 23, i32* %call, align 4, !dbg !766, !tbaa !743
  ret i32 -1, !dbg !767
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !770
  store i32 1, i32* %call, align 4, !dbg !770, !tbaa !743
  ret i32 -1, !dbg !771
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !774
  store i32 1, i32* %call, align 4, !dbg !774, !tbaa !743
  ret i32 -1, !dbg !775
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !778
  store i32 1, i32* %call, align 4, !dbg !778, !tbaa !743
  ret i32 -1, !dbg !779
}
...
entry:
  ...
  %call = call i32 @gettimeofday(%struct.timeval* %tv, %struct.timezone* null) #9, !dbg !784
  %tv_sec = getelementptr inbounds %struct.timeval* %tv, i64 0, i32 0, !dbg !785
  %0 = load i64* %tv_sec, align 8, !dbg !785, !tbaa !786
  %tv_sec1 = getelementptr inbounds %struct.timespec* %res, i64 0, i32 0, !dbg !785
  store i64 %0, i64* %tv_sec1, align 8, !dbg !785, !tbaa !789
  %tv_usec = getelementptr inbounds %struct.timeval* %tv, i64 0, i32 1, !dbg !791
  %1 = load i64* %tv_usec, align 8, !dbg !791, !tbaa !792
  %mul = mul nsw i64 %1, 1000, !dbg !791
  %tv_nsec = getelementptr inbounds %struct.timespec* %res, i64 0, i32 1, !dbg !791
  store i64 %mul, i64* %tv_nsec, align 8, !dbg !791, !tbaa !793
  ret i32 0, !dbg !794
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !797
  store i32 1, i32* %call, align 4, !dbg !797, !tbaa !743
  ret i32 -1, !dbg !798
}
...
entry:
  ...
  %call = call i32 @gettimeofday(%struct.timeval* %tv, %struct.timezone* null) #9, !dbg !801
  %tobool = icmp eq i64* %t, null, !dbg !802
  %tv_sec1.phi.trans.insert = getelementptr inbounds %struct.timeval* %tv, i64 0, i32 0
  %.pre = load i64* %tv_sec1.phi.trans.insert, align 8, !dbg !804, !tbaa !786
  br i1 %tobool, label %if.end, label %if.then, !dbg !802
...
entry:
  ...
  %0 = bitcast %struct.tms* %buf to i8*, !dbg !808
  call void @llvm.memset.p0i8.i64(i8* %0, i8 0, i64 32, i32 8, i1 false), !dbg !809
  ret i64 0, !dbg !808
}
...
entry:
  %call = tail call %struct.utmp* @getutent() #9, !dbg !810
  %0 = bitcast %struct.utmp* %call to %struct.utmpx*, !dbg !810
  ret %struct.utmpx* %0, !dbg !810
}
...
entry:
  ...
  %call = tail call i32 @utmpname(i8* %file) #9, !dbg !816
  ret i32 0, !dbg !817
}
...
entry:
  ...
  %call = tail call i32 @access(i8* %pathname, i32 %mode) #9, !dbg !819
...
entry:
  ...
  %call = tail call i32 @euidaccess(i8* %pathname, i32 %mode) #9, !dbg !821
...
entry:
  ...
  %call = tail call i32 @getgid() #9, !dbg !823
  %cmp = icmp eq i32 %call, %__gid, !dbg !823
  br i1 %cmp, label %lor.end, label %lor.rhs, !dbg !823

lor.rhs:                                          ; preds = %entry
  %call1 = tail call i32 @getegid() #9, !dbg !823
  %cmp2 = icmp eq i32 %call1, %__gid, !dbg !823
  br label %lor.end, !dbg !823

lor.end:                                          ; preds = %lor.rhs, %entry
  %0 = phi i1 [ true, %entry ], [ %cmp2, %lor.rhs ]
  %lor.ext = zext i1 %0 to i32, !dbg !823
  ret i32 %lor.ext, !dbg !823
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !826
  store i32 1, i32* %call, align 4, !dbg !826, !tbaa !743
  ret i32 -1, !dbg !827
}
...
entry:
  ...
  store i32 9, i32* %call, align 4, !dbg !830, !tbaa !743
  ret i32 -1, !dbg !831
}
...
entry:
  ...
  %call = tail call i32 @strcmp(i8* %__s1, i8* %__s2) #9, !dbg !833
...
entry:
  ...
  %shr = lshr i64 %__dev, 8, !dbg !835
  %and = and i64 %shr, 4095, !dbg !835
  %shr1 = lshr i64 %__dev, 32, !dbg !835
  %and2 = and i64 %shr1, 4294963200, !dbg !835
  %or = or i64 %and, %and2, !dbg !835
  %conv4 = trunc i64 %or to i32, !dbg !835
  ret i32 %conv4, !dbg !835
}
...
entry:
  ...
  %and = and i64 %__dev, 255, !dbg !837
  %shr = lshr i64 %__dev, 12, !dbg !837
  %and1 = and i64 %shr, 4294967040, !dbg !837
  %or = or i64 %and1, %and, !dbg !837
  %conv3 = trunc i64 %or to i32, !dbg !837
  ret i32 %conv3, !dbg !837
}
...
entry:
  ...
  %and = and i32 %__minor, 255, !dbg !839
  %and1 = shl i32 %__major, 8, !dbg !839
  %shl = and i32 %and1, 1048320, !dbg !839
  %or = or i32 %and, %shl, !dbg !839
  %conv = zext i32 %or to i64, !dbg !839
  %and2 = and i32 %__minor, -256, !dbg !839
  %conv3 = zext i32 %and2 to i64, !dbg !839
  %shl4 = shl nuw nsw i64 %conv3, 12, !dbg !839
  %and6 = and i32 %__major, -4096, !dbg !839
  %conv7 = zext i32 %and6 to i64, !dbg !839
  %shl8 = shl nuw i64 %conv7, 32, !dbg !839
  %or5 = or i64 %shl4, %shl8, !dbg !839
  %or9 = or i64 %or5, %conv, !dbg !839
  ret i64 %or9, !dbg !839
}
...
entry:
  ...
  %call = tail call i8* @realpath(i8* %name, i8* null) #9, !dbg !841
  ret i8* %call, !dbg !841
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !847
  store i32 10, i32* %call, align 4, !dbg !847, !tbaa !743
  ret i32 -1, !dbg !848
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !851
  store i32 10, i32* %call, align 4, !dbg !851, !tbaa !743
  ret i32 -1, !dbg !852
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !855
  store i32 10, i32* %call, align 4, !dbg !855, !tbaa !743
  ret i32 -1, !dbg !856
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !859
  store i32 10, i32* %call, align 4, !dbg !859, !tbaa !743
  ret i32 -1, !dbg !860
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !863
  store i32 10, i32* %call, align 4, !dbg !863, !tbaa !743
  ret i32 -1, !dbg !864
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !867
  store i32 1, i32* %call, align 4, !dbg !867, !tbaa !743
  ret i32 -1, !dbg !868
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !871
  store i32 1, i32* %call, align 4, !dbg !871, !tbaa !743
  ret i32 -1, !dbg !872
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !875
  store i32 1, i32* %call, align 4, !dbg !875, !tbaa !743
  ret i32 -1, !dbg !876
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !879
  store i32 1, i32* %call, align 4, !dbg !879, !tbaa !743
  ret i32 -1, !dbg !880
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !883
  store i32 1, i32* %call, align 4, !dbg !883, !tbaa !743
  ret i32 -1, !dbg !884
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !890
  store i32 1, i32* %call, align 4, !dbg !890, !tbaa !743
  ret i32 -1, !dbg !891
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !894
  store i32 1, i32* %call, align 4, !dbg !894, !tbaa !743
  ret i32 -1, !dbg !895
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !898
  store i32 1, i32* %call, align 4, !dbg !898, !tbaa !743
  ret i32 -1, !dbg !899
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !901
  store i32 1, i32* %call, align 4, !dbg !901, !tbaa !743
  ret i32 -1, !dbg !902
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !905
  store i32 1, i32* %call, align 4, !dbg !905, !tbaa !743
  ret i32 -1, !dbg !906
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !909
  store i32 1, i32* %call, align 4, !dbg !909, !tbaa !743
  ret i32 -1, !dbg !910
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !913
  store i32 1, i32* %call, align 4, !dbg !913, !tbaa !743
  ret i32 -1, !dbg !914
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !917
  store i32 1, i32* %call, align 4, !dbg !917, !tbaa !743
  ret i32 -1, !dbg !918
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !921
  store i32 1, i32* %call, align 4, !dbg !921, !tbaa !743
  ret i32 -1, !dbg !922
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !924
  store i32 1, i32* %call, align 4, !dbg !924, !tbaa !743
  ret i32 -1, !dbg !925
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !928
  store i32 1, i32* %call, align 4, !dbg !928, !tbaa !743
  ret i32 -1, !dbg !929
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !935
  store i32 1, i32* %call, align 4, !dbg !935, !tbaa !743
  ret i32 -1, !dbg !936
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !939
  store i32 1, i32* %call, align 4, !dbg !939, !tbaa !743
  ret i32 -1, !dbg !940
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !943
  store i32 1, i32* %call, align 4, !dbg !943, !tbaa !743
  ret i32 -1, !dbg !944
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !946
  store i32 1, i32* %call, align 4, !dbg !946, !tbaa !743
  ret i32 -1, !dbg !947
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !950
  store i32 1, i32* %call, align 4, !dbg !950, !tbaa !743
  ret i64 -1, !dbg !951
}
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !954
  store i32 1, i32* %call, align 4, !dbg !954, !tbaa !743
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !958
  store i32 1, i32* %call, align 4, !dbg !958, !tbaa !743
...
entry:
  ...
  %call = tail call i32* @__errno_location() #1, !dbg !962
  store i32 1, i32* %call, align 4, !dbg !962, !tbaa !743
  ret i32 -1, !dbg !963
}
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !36, metadata !37, metadata !36, metadata !36, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/POSIX//home/joker/klee-lf/runtime/POSIX/stubs.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/POSIX/stubs.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!4 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/waitflags.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!10 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/resource.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!39 = metadata !{metadata !"stubs.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
!40 = metadata !{i32 786473, metadata !39}        ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/POSIX/stubs.c]
...
!47 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/sigaction.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!64 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/siginfo.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!133 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/sigset.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!189 = metadata !{metadata !"/usr/include/libio.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!295 = metadata !{metadata !"/usr/include/time.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!315 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/time.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!340 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/sys/times.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!383 = metadata !{metadata !"/usr/include/utime.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!403 = metadata !{i32 786443, metadata !39, metadata !398, i32 235, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/stubs.c]
...
!659 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/sys/time.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!725 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
...
!803 = metadata !{i32 786443, metadata !39, metadata !326, i32 170, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/stubs.c]
...
!841 = metadata !{i32 257, i32 0, metadata !420, null}
