...
entry:
  ...
  %and = and i32 %flags, 64, !dbg !264
  %tobool = icmp eq i32 %and, 0, !dbg !264
...
if.then:                                          ; preds = %entry
  ...
  %arraydecay1 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*, !dbg !266
  call void @llvm.va_start(i8* %arraydecay1), !dbg !266
  %gp_offset_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0, !dbg !267
  %gp_offset = load i32* %gp_offset_p, align 16, !dbg !267
  %fits_in_gp = icmp ult i32 %gp_offset, 41, !dbg !267
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !267

vaarg.in_reg:                                     ; preds = %if.then
  %0 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3, !dbg !267
  %reg_save_area = load i8** %0, align 16, !dbg !267
  %1 = sext i32 %gp_offset to i64, !dbg !267
  %2 = getelementptr i8* %reg_save_area, i64 %1, !dbg !267
  %3 = add i32 %gp_offset, 8, !dbg !267
  store i32 %3, i32* %gp_offset_p, align 16, !dbg !267
  br label %vaarg.end, !dbg !267

vaarg.in_mem:                                     ; preds = %if.then
  %overflow_arg_area_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2, !dbg !267
  %overflow_arg_area = load i8** %overflow_arg_area_p, align 8, !dbg !267
  %overflow_arg_area.next = getelementptr i8* %overflow_arg_area, i64 8, !dbg !267
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !267
  br label %vaarg.end, !dbg !267

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %2, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32*, !dbg !267
  %4 = load i32* %vaarg.addr, align 4, !dbg !267
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !16), !dbg !267
  call void @llvm.va_end(i8* %arraydecay1), !dbg !268
  br label %if.end, !dbg !269

if.end:                                           ; preds = %entry, %vaarg.end
  %mode.0 = phi i32 [ %4, %vaarg.end ], [ 0, %entry ]
  %call = call i32 @__fd_open(i8* %pathname, i32 %flags, i32 %mode.0) #2, !dbg !270
...
entry:
  ...
  %and = and i32 %flags, 64, !dbg !273
  %tobool = icmp eq i32 %and, 0, !dbg !273
...
if.then:                                          ; preds = %entry
  ...
  %arraydecay1 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*, !dbg !275
  call void @llvm.va_start(i8* %arraydecay1), !dbg !275
  %gp_offset_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0, !dbg !276
  %gp_offset = load i32* %gp_offset_p, align 16, !dbg !276
  %fits_in_gp = icmp ult i32 %gp_offset, 41, !dbg !276
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !276

vaarg.in_reg:                                     ; preds = %if.then
  %0 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3, !dbg !276
  %reg_save_area = load i8** %0, align 16, !dbg !276
  %1 = sext i32 %gp_offset to i64, !dbg !276
  %2 = getelementptr i8* %reg_save_area, i64 %1, !dbg !276
  %3 = add i32 %gp_offset, 8, !dbg !276
  store i32 %3, i32* %gp_offset_p, align 16, !dbg !276
  br label %vaarg.end, !dbg !276

vaarg.in_mem:                                     ; preds = %if.then
  %overflow_arg_area_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2, !dbg !276
  %overflow_arg_area = load i8** %overflow_arg_area_p, align 8, !dbg !276
  %overflow_arg_area.next = getelementptr i8* %overflow_arg_area, i64 8, !dbg !276
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !276
  br label %vaarg.end, !dbg !276

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %2, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32*, !dbg !276
  %4 = load i32* %vaarg.addr, align 4, !dbg !276
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !44), !dbg !276
  call void @llvm.va_end(i8* %arraydecay1), !dbg !277
  br label %if.end, !dbg !278

if.end:                                           ; preds = %entry, %vaarg.end
  %mode.0 = phi i32 [ %4, %vaarg.end ], [ 0, %entry ]
  %call = call i32 @__fd_openat(i32 %fd, i8* %pathname, i32 %flags, i32 %mode.0) #2, !dbg !279
...
entry:
  ...
  %call = tail call i64 @__fd_lseek(i32 %fd, i64 %off, i32 %whence) #2, !dbg !281
  ret i64 %call, !dbg !281
}
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !283
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !283
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !102), !dbg !283
  %call = call i32 @__fd_stat(i8* %path, %struct.stat64* %tmp) #2, !dbg !284
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !122), !dbg !284
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !289
  %2 = load <2 x i64>* %1, align 16, !dbg !289, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !289
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !289, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !294
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !294
  %5 = load i64* %4, align 8, !dbg !294
  %6 = trunc i64 %5 to i32, !dbg !294
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !294
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !294, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !299
  %7 = load i64* %st_nlink.i, align 16, !dbg !299, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !299
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !299, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !303
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !303, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !305
  %10 = load i32* %st_gid.i, align 16, !dbg !305, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !305
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !305, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !308
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !308
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !308
  %12 = load <2 x i64>* %11, align 8, !dbg !308, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !308
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !308, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !309
  %14 = load i64* %tv_sec.i, align 8, !dbg !309, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !309
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !309, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !312
  %15 = load i64* %tv_sec11.i, align 8, !dbg !312, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !312
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !312, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !315
  %16 = load i64* %tv_sec14.i, align 8, !dbg !315, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !315
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !315, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !318
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !318
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !318
  %18 = load <2 x i64>* %17, align 8, !dbg !318, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !318
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !318, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !319
  %20 = load i64* %tv_nsec.i, align 8, !dbg !319, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !319
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !319, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !322
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !322, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !322
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !322, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !325
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !325, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !325
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !325, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !328
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !330
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !330
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !129), !dbg !330
  %call = call i32 @__fd_stat(i8* %path, %struct.stat64* %tmp) #2, !dbg !331
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !130), !dbg !331
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !336
  %2 = load <2 x i64>* %1, align 16, !dbg !336, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !336
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !336, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !337
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !337
  %5 = load i64* %4, align 8, !dbg !337
  %6 = trunc i64 %5 to i32, !dbg !337
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !337
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !337, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !338
  %7 = load i64* %st_nlink.i, align 16, !dbg !338, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !338
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !338, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !339
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !339, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !340
  %10 = load i32* %st_gid.i, align 16, !dbg !340, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !340
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !340, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !341
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !341
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !341
  %12 = load <2 x i64>* %11, align 8, !dbg !341, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !341
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !341, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !342
  %14 = load i64* %tv_sec.i, align 8, !dbg !342, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !342
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !342, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !343
  %15 = load i64* %tv_sec11.i, align 8, !dbg !343, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !343
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !343, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !344
  %16 = load i64* %tv_sec14.i, align 8, !dbg !344, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !344
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !344, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !345
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !345
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !345
  %18 = load <2 x i64>* %17, align 8, !dbg !345, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !345
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !345, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !346
  %20 = load i64* %tv_nsec.i, align 8, !dbg !346, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !346
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !346, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !347
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !347, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !347
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !347, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !348
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !348, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !348
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !348, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !349
  ret i32 %call, !dbg !349
}
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !351
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !351
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !136), !dbg !351
  %call = call i32 @__fd_lstat(i8* %path, %struct.stat64* %tmp) #2, !dbg !352
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !137), !dbg !352
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !357
  %2 = load <2 x i64>* %1, align 16, !dbg !357, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !357
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !357, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !358
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !358
  %5 = load i64* %4, align 8, !dbg !358
  %6 = trunc i64 %5 to i32, !dbg !358
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !358
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !358, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !359
  %7 = load i64* %st_nlink.i, align 16, !dbg !359, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !359
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !359, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !360
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !360, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !361
  %10 = load i32* %st_gid.i, align 16, !dbg !361, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !361
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !361, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !362
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !362
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !362
  %12 = load <2 x i64>* %11, align 8, !dbg !362, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !362
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !362, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !363
  %14 = load i64* %tv_sec.i, align 8, !dbg !363, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !363
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !363, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !364
  %15 = load i64* %tv_sec11.i, align 8, !dbg !364, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !364
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !364, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !365
  %16 = load i64* %tv_sec14.i, align 8, !dbg !365, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !365
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !365, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !366
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !366
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !366
  %18 = load <2 x i64>* %17, align 8, !dbg !366, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !366
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !366, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !367
  %20 = load i64* %tv_nsec.i, align 8, !dbg !367, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !367
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !367, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !368
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !368, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !368
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !368, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !369
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !369, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !369
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !369, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !370
  ret i32 %call, !dbg !370
}
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !372
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !372
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !142), !dbg !372
  %call = call i32 @__fd_lstat(i8* %path, %struct.stat64* %tmp) #2, !dbg !373
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !143), !dbg !373
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !378
  %2 = load <2 x i64>* %1, align 16, !dbg !378, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !378
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !378, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !379
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !379
  %5 = load i64* %4, align 8, !dbg !379
  %6 = trunc i64 %5 to i32, !dbg !379
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !379
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !379, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !380
  %7 = load i64* %st_nlink.i, align 16, !dbg !380, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !380
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !380, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !381
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !381, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !382
  %10 = load i32* %st_gid.i, align 16, !dbg !382, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !382
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !382, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !383
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !383
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !383
  %12 = load <2 x i64>* %11, align 8, !dbg !383, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !383
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !383, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !384
  %14 = load i64* %tv_sec.i, align 8, !dbg !384, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !384
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !384, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !385
  %15 = load i64* %tv_sec11.i, align 8, !dbg !385, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !385
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !385, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !386
  %16 = load i64* %tv_sec14.i, align 8, !dbg !386, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !386
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !386, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !387
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !387
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !387
  %18 = load <2 x i64>* %17, align 8, !dbg !387, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !387
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !387, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !388
  %20 = load i64* %tv_nsec.i, align 8, !dbg !388, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !388
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !388, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !389
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !389, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !389
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !389, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !390
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !390, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !390
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !390, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !391
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !393
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !393
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !151), !dbg !393
  %call = call i32 @__fd_fstat(i32 %fd, %struct.stat64* %tmp) #2, !dbg !394
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !152), !dbg !394
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !399
  %2 = load <2 x i64>* %1, align 16, !dbg !399, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !399
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !399, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !400
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !400
  %5 = load i64* %4, align 8, !dbg !400
  %6 = trunc i64 %5 to i32, !dbg !400
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !400
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !400, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !401
  %7 = load i64* %st_nlink.i, align 16, !dbg !401, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !401
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !401, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !402
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !402, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !403
  %10 = load i32* %st_gid.i, align 16, !dbg !403, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !403
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !403, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !404
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !404
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !404
  %12 = load <2 x i64>* %11, align 8, !dbg !404, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !404
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !404, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !405
  %14 = load i64* %tv_sec.i, align 8, !dbg !405, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !405
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !405, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !406
  %15 = load i64* %tv_sec11.i, align 8, !dbg !406, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !406
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !406, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !407
  %16 = load i64* %tv_sec14.i, align 8, !dbg !407, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !407
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !407, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !408
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !408
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !408
  %18 = load <2 x i64>* %17, align 8, !dbg !408, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !408
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !408, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !409
  %20 = load i64* %tv_nsec.i, align 8, !dbg !409, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !409
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !409, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !410
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !410, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !410
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !410, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !411
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !411, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !411
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !411, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !412
...
entry:
  ...
  %0 = bitcast %struct.stat64* %tmp to i8*, !dbg !414
  call void @llvm.lifetime.start(i64 144, i8* %0) #2, !dbg !414
  call void @llvm.dbg.declare(metadata !{%struct.stat64* %tmp}, metadata !159), !dbg !414
  %call = call i32 @__fd_fstat(i32 %fd, %struct.stat64* %tmp) #2, !dbg !415
  call void @llvm.dbg.value(metadata !{i32 %call}, i64 0, metadata !160), !dbg !415
  ...
  %1 = bitcast %struct.stat64* %tmp to <2 x i64>*, !dbg !420
  %2 = load <2 x i64>* %1, align 16, !dbg !420, !tbaa !290
  %3 = bitcast %struct.stat* %buf to <2 x i64>*, !dbg !420
  store <2 x i64> %2, <2 x i64>* %3, align 8, !dbg !420, !tbaa !290
  %st_mode.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 3, !dbg !421
  %4 = bitcast i32* %st_mode.i to i64*, !dbg !421
  %5 = load i64* %4, align 8, !dbg !421
  %6 = trunc i64 %5 to i32, !dbg !421
  %st_mode3.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 3, !dbg !421
  store i32 %6, i32* %st_mode3.i, align 4, !dbg !421, !tbaa !295
  %st_nlink.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 2, !dbg !422
  %7 = load i64* %st_nlink.i, align 16, !dbg !422, !tbaa !300
  %st_nlink4.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 2, !dbg !422
  store i64 %7, i64* %st_nlink4.i, align 8, !dbg !422, !tbaa !302
  %8 = lshr i64 %5, 32
  %9 = trunc i64 %8 to i32
  %st_uid5.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 4, !dbg !423
  store i32 %9, i32* %st_uid5.i, align 4, !dbg !423, !tbaa !304
  %st_gid.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 5, !dbg !424
  %10 = load i32* %st_gid.i, align 16, !dbg !424, !tbaa !306
  %st_gid6.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 5, !dbg !424
  store i32 %10, i32* %st_gid6.i, align 4, !dbg !424, !tbaa !307
  %st_rdev.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 7, !dbg !425
  %st_rdev7.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 7, !dbg !425
  %11 = bitcast i64* %st_rdev.i to <2 x i64>*, !dbg !425
  %12 = load <2 x i64>* %11, align 8, !dbg !425, !tbaa !290
  %13 = bitcast i64* %st_rdev7.i to <2 x i64>*, !dbg !425
  store <2 x i64> %12, <2 x i64>* %13, align 8, !dbg !425, !tbaa !290
  %tv_sec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 0, !dbg !426
  %14 = load i64* %tv_sec.i, align 8, !dbg !426, !tbaa !310
  %tv_sec10.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 0, !dbg !426
  store i64 %14, i64* %tv_sec10.i, align 8, !dbg !426, !tbaa !311
  %tv_sec11.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 0, !dbg !427
  %15 = load i64* %tv_sec11.i, align 8, !dbg !427, !tbaa !313
  %tv_sec13.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 0, !dbg !427
  store i64 %15, i64* %tv_sec13.i, align 8, !dbg !427, !tbaa !314
  %tv_sec14.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 0, !dbg !428
  %16 = load i64* %tv_sec14.i, align 8, !dbg !428, !tbaa !316
  %tv_sec16.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 0, !dbg !428
  store i64 %16, i64* %tv_sec16.i, align 8, !dbg !428, !tbaa !317
  %st_blksize.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 9, !dbg !429
  %st_blksize17.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 9, !dbg !429
  %17 = bitcast i64* %st_blksize.i to <2 x i64>*, !dbg !429
  %18 = load <2 x i64>* %17, align 8, !dbg !429, !tbaa !290
  %19 = bitcast i64* %st_blksize17.i to <2 x i64>*, !dbg !429
  store <2 x i64> %18, <2 x i64>* %19, align 8, !dbg !429, !tbaa !290
  %tv_nsec.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 11, i32 1, !dbg !430
  %20 = load i64* %tv_nsec.i, align 8, !dbg !430, !tbaa !320
  %tv_nsec21.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 11, i32 1, !dbg !430
  store i64 %20, i64* %tv_nsec21.i, align 8, !dbg !430, !tbaa !321
  %tv_nsec23.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 12, i32 1, !dbg !431
  %21 = load i64* %tv_nsec23.i, align 8, !dbg !431, !tbaa !323
  %tv_nsec25.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 12, i32 1, !dbg !431
  store i64 %21, i64* %tv_nsec25.i, align 8, !dbg !431, !tbaa !324
  %tv_nsec27.i = getelementptr inbounds %struct.stat64* %tmp, i64 0, i32 13, i32 1, !dbg !432
  %22 = load i64* %tv_nsec27.i, align 8, !dbg !432, !tbaa !326
  %tv_nsec29.i = getelementptr inbounds %struct.stat* %buf, i64 0, i32 13, i32 1, !dbg !432
  store i64 %22, i64* %tv_nsec29.i, align 8, !dbg !432, !tbaa !327
  call void @llvm.lifetime.end(i64 144, i8* %0) #2, !dbg !433
...
entry:
  ...
  %call = tail call i32 @__fd_ftruncate(i32 %fd, i64 %length) #2, !dbg !435
...
entry:
  ...
  %call = tail call i32 @__fd_statfs(i8* %path, %struct.statfs* %buf32) #2, !dbg !437
...
entry:
  ...
  %0 = bitcast %struct.dirent* %dirp to %struct.dirent64*, !dbg !439
  tail call void @llvm.dbg.value(metadata !{%struct.dirent64* %0}, i64 0, metadata !227), !dbg !439
  %conv = trunc i64 %nbytes to i32, !dbg !440
  %call = tail call i32 @__fd_getdents(i32 %fd, %struct.dirent64* %0, i32 %conv) #2, !dbg !440
  %conv1 = sext i32 %call to i64, !dbg !440
  tail call void @llvm.dbg.value(metadata !{i64 %conv1}, i64 0, metadata !237), !dbg !440
  %cmp = icmp sgt i32 %call, 0, !dbg !441
  br i1 %cmp, label %if.then, label %if.end, !dbg !441

if.then:                                          ; preds = %entry
  %1 = bitcast %struct.dirent* %dirp to i8*, !dbg !442
  %add.ptr = getelementptr inbounds i8* %1, i64 %conv1, !dbg !442
  %2 = bitcast i8* %add.ptr to %struct.dirent*, !dbg !443
  %cmp332 = icmp ugt %struct.dirent* %2, %dirp, !dbg !443
  br i1 %cmp332, label %while.body, label %if.end, !dbg !443

while.body:                                       ; preds = %if.then, %while.body
  %dp64.033 = phi %struct.dirent64* [ %5, %while.body ], [ %0, %if.then ]
  %d_reclen = getelementptr inbounds %struct.dirent64* %dp64.033, i64 0, i32 2, !dbg !444
  %3 = bitcast %struct.dirent64* %dp64.033 to i8*, !dbg !445
  %4 = load i16* %d_reclen, align 2, !dbg !445, !tbaa !446
  %idx.ext = zext i16 %4 to i64, !dbg !445
  %add.ptr14 = getelementptr inbounds i8* %3, i64 %idx.ext, !dbg !445
  %5 = bitcast i8* %add.ptr14 to %struct.dirent64*, !dbg !445
  tail call void @llvm.dbg.value(metadata !{%struct.dirent64* %5}, i64 0, metadata !227), !dbg !445
  %cmp3 = icmp ult i8* %add.ptr14, %add.ptr, !dbg !443
  br i1 %cmp3, label %while.body, label %if.end, !dbg !443

if.end:                                           ; preds = %while.body, %if.then, %entry
  ret i64 %conv1, !dbg !449
}
...
entry:
  ...
  %and = and i32 %flags, 64, !dbg !452
  %tobool = icmp eq i32 %and, 0, !dbg !452
  br i1 %tobool, label %if.end, label %if.then, !dbg !452

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata !{[1 x %struct.__va_list_tag]* %ap}, metadata !249), !dbg !453
  %arraydecay1 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*, !dbg !454
  call void @llvm.va_start(i8* %arraydecay1), !dbg !454
  %gp_offset_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0, !dbg !455
  %gp_offset = load i32* %gp_offset_p, align 16, !dbg !455
  %fits_in_gp = icmp ult i32 %gp_offset, 41, !dbg !455
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !455

vaarg.in_reg:                                     ; preds = %if.then
  %0 = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3, !dbg !455
  %reg_save_area = load i8** %0, align 16, !dbg !455
  %1 = sext i32 %gp_offset to i64, !dbg !455
  %2 = getelementptr i8* %reg_save_area, i64 %1, !dbg !455
  %3 = add i32 %gp_offset, 8, !dbg !455
  store i32 %3, i32* %gp_offset_p, align 16, !dbg !455
  br label %vaarg.end, !dbg !455

vaarg.in_mem:                                     ; preds = %if.then
  %overflow_arg_area_p = getelementptr inbounds [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2, !dbg !455
  %overflow_arg_area = load i8** %overflow_arg_area_p, align 8, !dbg !455
  %overflow_arg_area.next = getelementptr i8* %overflow_arg_area, i64 8, !dbg !455
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !455
  br label %vaarg.end, !dbg !455

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %2, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32*, !dbg !455
  %4 = load i32* %vaarg.addr, align 4, !dbg !455
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !248), !dbg !455
  call void @llvm.va_end(i8* %arraydecay1), !dbg !456
  br label %if.end, !dbg !457

if.end:                                           ; preds = %entry, %vaarg.end
  %mode.0 = phi i32 [ %4, %vaarg.end ], [ 0, %entry ]
  %call = call i32 @__fd_open(i8* %pathname, i32 %flags, i32 %mode.0) #2, !dbg !458
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"clang version 3.4 (tags/RELEASE_34/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/joker/klee-lf/runtime/POSIX//home/joker/klee-lf/runtime/POSIX/fd_32.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/joker/klee-lf/runtime/POSIX/fd_32.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"fd_32.c", metadata !"/home/joker/klee-lf/runtime/POSIX"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!21 = metadata !{i32 786443, metadata !5, metadata !22, i32 68, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
!22 = metadata !{i32 786443, metadata !5, metadata !4, i32 68, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!46 = metadata !{i32 786443, metadata !5, metadata !47, i32 82, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
!47 = metadata !{i32 786443, metadata !5, metadata !37, i32 82, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!63 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/stat.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!86 = metadata !{metadata !"/usr/include/time.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!172 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/statfs.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!187 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/types.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!210 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/dirent.h", metadata !"/home/joker/klee-lf/runtime/POSIX"}
...
!239 = metadata !{i32 786443, metadata !5, metadata !240, i32 172, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
!240 = metadata !{i32 786443, metadata !5, metadata !203, i32 172, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!242 = metadata !{i32 786443, metadata !5, metadata !239, i32 174, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!250 = metadata !{i32 786443, metadata !5, metadata !251, i32 197, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
!251 = metadata !{i32 786443, metadata !5, metadata !244, i32 197, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/joker/klee-lf/runtime/POSIX/fd_32.c]
...
!261 = metadata !{metadata !"clang version 3.4 (tags/RELEASE_34/final)"}
