...
public:
  ...
  enum Kind {
    ...
    Ult,		//cyj: 小于
    Ule,	//cyj: 小于等于
    Ugt, ///< Not used in canonical form		//cyj: 大于
    Uge, ///< Not used in canonical form		//cyj: 大于等于
    Slt,
    Sle,
...
private:
  llvm::APInt value;		//cyj: APInt: arbitrary precision integers
...
public:
  ...
  //cyj: ConstantExpr.(APInt)Value = v
