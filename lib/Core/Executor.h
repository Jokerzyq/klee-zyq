...
//cyj modify, primitive code is "private:"
protected:
  class TimerInfo;
...
//                           const std::string &name);
  ...
  //cyj: stack里最后一个指令的第dest个cell(Destination register)
  Cell& getDestCell(ExecutionState &state,
                    KInstruction *target) {		//cyj: Dest: Destination register index
